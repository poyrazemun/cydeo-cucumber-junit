...
public class OrderStepDefinitions {
    ...
    public void user_selects_credit_card_type(String expectedCardType) {
        ...
        BrowserUtils.clickRadioButton(orderPage.cardType, expectedCardType);//utility method sayesinde tek satir!!
    ...
    public void user_should_see_in_first_row_of_the_web_table(String string) {
        Assert.assertTrue(string.equals(viewAllOrdersPage.newCustomerCell.getText()));
    }
}
